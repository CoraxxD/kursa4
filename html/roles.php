 ...
 */
    ...
    class public_roles_public_usersPage extends DetailPage
    {
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->SetHandlerName('filter_builder_public_roles_public_users_roleid_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('roleid', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_public_roles_public_users_roleid_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_public_roles_public_users_officeid_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('officeid', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_public_roles_public_users_officeid_search');
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editColumn = new DynamicLookupEditColumn('Roleid', 'roleid', 'LA1', 'edit_public_roles_public_users_roleid_search', $editor, $this->dataset, $lookupDataset, 'id', 'title', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            $editColumn = new DynamicLookupEditColumn('Officeid', 'officeid', 'LA2', 'edit_public_roles_public_users_officeid_search', $editor, $this->dataset, $lookupDataset, 'id', 'countryid', '');
        ...
        protected function AddMultiEditColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('title', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Roleid', 'roleid', 'LA1', 'multi_edit_public_roles_public_users_roleid_search', $editor, $this->dataset, $lookupDataset, 'id', 'title', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            ...
            $lookupDataset->setOrderByField('countryid', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Officeid', 'officeid', 'LA2', 'multi_edit_public_roles_public_users_officeid_search', $editor, $this->dataset, $lookupDataset, 'id', 'countryid', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
        ...
        protected function AddInsertColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('title', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Roleid', 'roleid', 'LA1', 'insert_public_roles_public_users_roleid_search', $editor, $this->dataset, $lookupDataset, 'id', 'title', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('countryid', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Officeid', 'officeid', 'LA2', 'insert_public_roles_public_users_officeid_search', $editor, $this->dataset, $lookupDataset, 'id', 'countryid', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
        ...
        protected function doRegisterHandlers() {
            ...
            $lookupDataset->setOrderByField('title', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_public_roles_public_users_roleid_search', 'id', 'title', null, 20);
            ...
            $lookupDataset->setOrderByField('countryid', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_public_roles_public_users_officeid_search', 'id', 'countryid', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('title', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_public_roles_public_users_roleid_search', 'id', 'title', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('countryid', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_public_roles_public_users_officeid_search', 'id', 'countryid', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('title', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_public_roles_public_users_roleid_search', 'id', 'title', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('countryid', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_public_roles_public_users_officeid_search', 'id', 'countryid', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('title', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_public_roles_public_users_roleid_search', 'id', 'title', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('countryid', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_public_roles_public_users_officeid_search', 'id', 'countryid', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    class public_rolesPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Roles');
            $this->SetMenuLabel('Roles');
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            if (GetCurrentUserPermissionsForPage('public.roles.public.users')->HasViewGrant() && $withDetails)
            {
            //
            // View column for public_roles_public_users detail
            //
            $column = new DetailColumn(array('id'), 'public.roles.public.users', 'public_roles_public_users_handler', $this->dataset, 'Users');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $grid->AddViewColumn($column);
            }
        ...
        protected function doRegisterHandlers() {
            $detailPage = new public_roles_public_usersPage('public_roles_public_users', $this, array('roleid'), array('id'), $this->GetForeignKeyFields(), $this->CreateMasterDetailRecordGrid(), $this->dataset, GetCurrentUserPermissionsForPage('public.roles.public.users'), 'UTF-8');
            $detailPage->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource('public.roles.public.users'));
            $detailPage->SetHttpHandlerName('public_roles_public_users_handler');
            $handler = new PageHTTPHandler('public_roles_public_users_handler', $detailPage);
            GetApplication()->RegisterHTTPHandler($handler);
    ...
    try
    {
        $Page = new public_rolesPage("public_roles", "roles.php", GetCurrentUserPermissionsForPage("public.roles"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("public.roles"));
