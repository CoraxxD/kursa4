 ...
 */
    ...
    class public_aircrafts_schedulesPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Aircrafts Schedules');
            $this->SetMenuLabel('Aircrafts Schedules');
    
            $this->dataset = new TableDataset(
                PgConnectionFactory::getInstance(),
                GetConnectionOptions(),
                '"public"."aircrafts_schedules"');
            $this->dataset->addFields(
                array(
                    new DateField('date', false, true),
                    new IntegerField('economyprice', false, true),
    ...
    try
    {
        $Page = new public_aircrafts_schedulesPage("public_aircrafts_schedules", "aircrafts_schedules.php", GetCurrentUserPermissionsForPage("public.aircrafts_schedules"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("public.aircrafts_schedules"));
