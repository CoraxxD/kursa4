 ...
 */
    ...
    class public_schedules_public_ticketsPage extends DetailPage
    {
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->SetHandlerName('filter_builder_public_schedules_public_tickets_userid_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('userid', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_public_schedules_public_tickets_userid_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_public_schedules_public_tickets_scheduleid_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('scheduleid', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_public_schedules_public_tickets_scheduleid_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_public_schedules_public_tickets_cabintypeid_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('cabintypeid', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_public_schedules_public_tickets_cabintypeid_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_public_schedules_public_tickets_passportcountryid_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('passportcountryid', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_public_schedules_public_tickets_passportcountryid_search');
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editColumn = new DynamicLookupEditColumn('Userid', 'userid', 'LA1', 'edit_public_schedules_public_tickets_userid_search', $editor, $this->dataset, $lookupDataset, 'id', 'roleid', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            $editColumn = new DynamicLookupEditColumn('Scheduleid', 'scheduleid', 'LA2', 'edit_public_schedules_public_tickets_scheduleid_search', $editor, $this->dataset, $lookupDataset, 'id', 'date', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            $editColumn = new DynamicLookupEditColumn('Cabintypeid', 'cabintypeid', 'LA3', 'edit_public_schedules_public_tickets_cabintypeid_search', $editor, $this->dataset, $lookupDataset, 'id', 'name', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Passportcountryid', 'passportcountryid', 'LA4', 'edit_public_schedules_public_tickets_passportcountryid_search', $editor, $this->dataset, $lookupDataset, 'id', 'name', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        ...
        protected function AddMultiEditColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('roleid', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Userid', 'userid', 'LA1', 'multi_edit_public_schedules_public_tickets_userid_search', $editor, $this->dataset, $lookupDataset, 'id', 'roleid', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            ...
            $lookupDataset->setOrderByField('date', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Scheduleid', 'scheduleid', 'LA2', 'multi_edit_public_schedules_public_tickets_scheduleid_search', $editor, $this->dataset, $lookupDataset, 'id', 'date', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Cabintypeid', 'cabintypeid', 'LA3', 'multi_edit_public_schedules_public_tickets_cabintypeid_search', $editor, $this->dataset, $lookupDataset, 'id', 'name', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Passportcountryid', 'passportcountryid', 'LA4', 'multi_edit_public_schedules_public_tickets_passportcountryid_search', $editor, $this->dataset, $lookupDataset, 'id', 'name', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
        ...
        protected function AddInsertColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('roleid', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Userid', 'userid', 'LA1', 'insert_public_schedules_public_tickets_userid_search', $editor, $this->dataset, $lookupDataset, 'id', 'roleid', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('date', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Scheduleid', 'scheduleid', 'LA2', 'insert_public_schedules_public_tickets_scheduleid_search', $editor, $this->dataset, $lookupDataset, 'id', 'date', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Cabintypeid', 'cabintypeid', 'LA3', 'insert_public_schedules_public_tickets_cabintypeid_search', $editor, $this->dataset, $lookupDataset, 'id', 'name', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Passportcountryid', 'passportcountryid', 'LA4', 'insert_public_schedules_public_tickets_passportcountryid_search', $editor, $this->dataset, $lookupDataset, 'id', 'name', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
        ...
        protected function doRegisterHandlers() {
            ...
            $lookupDataset->setOrderByField('roleid', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_public_schedules_public_tickets_userid_search', 'id', 'roleid', null, 20);
            ...
            $lookupDataset->setOrderByField('date', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_public_schedules_public_tickets_scheduleid_search', 'id', 'date', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_public_schedules_public_tickets_cabintypeid_search', 'id', 'name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_public_schedules_public_tickets_passportcountryid_search', 'id', 'name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('roleid', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_public_schedules_public_tickets_userid_search', 'id', 'roleid', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('date', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_public_schedules_public_tickets_scheduleid_search', 'id', 'date', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_public_schedules_public_tickets_cabintypeid_search', 'id', 'name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_public_schedules_public_tickets_passportcountryid_search', 'id', 'name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('roleid', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_public_schedules_public_tickets_userid_search', 'id', 'roleid', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('date', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_public_schedules_public_tickets_scheduleid_search', 'id', 'date', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_public_schedules_public_tickets_cabintypeid_search', 'id', 'name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_public_schedules_public_tickets_passportcountryid_search', 'id', 'name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('roleid', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_public_schedules_public_tickets_userid_search', 'id', 'roleid', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('date', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_public_schedules_public_tickets_scheduleid_search', 'id', 'date', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_public_schedules_public_tickets_cabintypeid_search', 'id', 'name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_public_schedules_public_tickets_passportcountryid_search', 'id', 'name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    class public_schedulesPage extends Page
    {
        protected function DoBeforeCreate()
        {
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_public_schedules_aircraftid_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('aircraftid', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_public_schedules_aircraftid_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_public_schedules_routeid_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('routeid', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_public_schedules_routeid_search');
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            if (GetCurrentUserPermissionsForPage('public.schedules.public.tickets')->HasViewGrant() && $withDetails)
            {
            //
            // View column for public_schedules_public_tickets detail
            //
            $column = new DetailColumn(array('id'), 'public.schedules.public.tickets', 'public_schedules_public_tickets_handler', $this->dataset, 'Tickets');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $grid->AddViewColumn($column);
            }
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Aircraftid', 'aircraftid', 'LA1', 'edit_public_schedules_aircraftid_search', $editor, $this->dataset, $lookupDataset, 'id', 'name', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            $editColumn = new DynamicLookupEditColumn('Routeid', 'routeid', 'LA2', 'edit_public_schedules_routeid_search', $editor, $this->dataset, $lookupDataset, 'id', 'departureairportid', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        ...
        protected function AddMultiEditColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Aircraftid', 'aircraftid', 'LA1', 'multi_edit_public_schedules_aircraftid_search', $editor, $this->dataset, $lookupDataset, 'id', 'name', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('departureairportid', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Routeid', 'routeid', 'LA2', 'multi_edit_public_schedules_routeid_search', $editor, $this->dataset, $lookupDataset, 'id', 'departureairportid', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
        ...
        protected function AddInsertColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Aircraftid', 'aircraftid', 'LA1', 'insert_public_schedules_aircraftid_search', $editor, $this->dataset, $lookupDataset, 'id', 'name', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('departureairportid', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Routeid', 'routeid', 'LA2', 'insert_public_schedules_routeid_search', $editor, $this->dataset, $lookupDataset, 'id', 'departureairportid', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
        ...
        protected function doRegisterHandlers() {
            $detailPage = new public_schedules_public_ticketsPage('public_schedules_public_tickets', $this, array('scheduleid'), array('id'), $this->GetForeignKeyFields(), $this->CreateMasterDetailRecordGrid(), $this->dataset, GetCurrentUserPermissionsForPage('public.schedules.public.tickets'), 'UTF-8');
            $detailPage->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource('public.schedules.public.tickets'));
            $detailPage->SetHttpHandlerName('public_schedules_public_tickets_handler');
            $handler = new PageHTTPHandler('public_schedules_public_tickets_handler', $detailPage);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_public_schedules_aircraftid_search', 'id', 'name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('departureairportid', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_public_schedules_routeid_search', 'id', 'departureairportid', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_public_schedules_aircraftid_search', 'id', 'name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('departureairportid', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_public_schedules_routeid_search', 'id', 'departureairportid', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_public_schedules_aircraftid_search', 'id', 'name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('departureairportid', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_public_schedules_routeid_search', 'id', 'departureairportid', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_public_schedules_aircraftid_search', 'id', 'name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('departureairportid', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_public_schedules_routeid_search', 'id', 'departureairportid', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    try
    {
        $Page = new public_schedulesPage("public_schedules", "schedules.php", GetCurrentUserPermissionsForPage("public.schedules"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("public.schedules"));
